...
with header_left:
    ...
    st.caption(
        "Платформа для построения деревьев научного руководства, поиска и сравнения диссертаций по содержательным и формальным критериям. В настоящий момент основу базы данных составляют диссертационные исследования по техническим наукам (группа специальностей "Информационные технологии и телекоммуникации") с 2005 по 2024 год."
    )
with header_right:
    feedback_button()
